...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6" style="color: #F5F0CD;">
            <h2>About</h2>
            <p>disini isi tentang perusahaanya, dikanan logo google di ganti karna gw cuma pake buat tes</p>
        </div>
        <div class="col-md-6 text-center">
            <div class="col-md-12 position-relative text-center" style="background-image: url('images/tes.png'); background-size: cover; background-position: center; height: 400px;">
        </div>
    </div>
</div>
